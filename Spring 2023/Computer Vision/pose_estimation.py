...
def estimate_pose(frame, dict_type, camera_matrix, distortion_coeffs, marker_length): # marker_length in meters prolly
    ...
    # gray = cv2.aruco.undistort(gray, camera_matrix, distortion_coeffs) # maybe not needed?
    ...
    if len(corners) > 0:
        ...
        for i, marker_id in enumerate(ids):
            ...
            ret, rvec, tvec = cv2.solvePnP(obj_points, corners[i], camera_matrix, distortion_coeffs)
